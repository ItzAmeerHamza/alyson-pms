...
<body>
    ...
    html_content := html_content || '
        ...
        <div class="footer">
            Generated by Alyson work time Admin System • ' || NOW() || '
        </div>
    </div>
</body>
</html>';
...
CREATE OR REPLACE FUNCTION "public"."is_org_admin"("user_id" "uuid" DEFAULT "auth"."uid"()) RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
...
CREATE OR REPLACE FUNCTION "public"."send_email_via_resend"("to_emails" "text"[], "subject" "text", "html_content" "text", "from_email" "text" DEFAULT 'Alyson work time Reports <info@ebdaadt.com>'::"text") RETURNS "jsonb"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    resend_api_key TEXT;
...
ALTER TABLE ONLY "public"."idle_logs"
    ADD CONSTRAINT "idle_logs_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."screenshot_comments"
    ADD CONSTRAINT "screenshot_comments_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
