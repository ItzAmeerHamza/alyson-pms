  ...
  public: {
    Tables: {
      ...
      manual_hours: {
        ...
        Relationships: [
          {
            foreignKeyName: "manual_hours_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "manual_hours_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "manual_hours_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      manual_hours_audit: {
        ...
        Relationships: [
          {
            foreignKeyName: "manual_hours_audit_changed_by_fkey"
            columns: ["changed_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "manual_hours_audit_manual_hours_id_fkey"
            columns: ["manual_hours_id"]
            isOneToOne: false
            referencedRelation: "manual_hours"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      screenshot_deletions: {
        ...
        Relationships: [
          {
            foreignKeyName: "screenshot_deletions_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      team_leader_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "team_leader_assignments_assigned_by_fkey"
            columns: ["assigned_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "team_leader_assignments_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "team_leader_assignments_team_leader_id_fkey"
    ...
    Functions: {
      ...
      check_email_budget: { Args: { increment_by?: number }; Returns: boolean }
      cleanup_orphaned_url_slices: { Args: never; Returns: undefined }
      cleanup_overnight_sessions: { Args: never; Returns: Json }
      close_user_active_sessions:
        | { Args: { p_user_id: string }; Returns: number }
        | { Args: { p_device_id?: string; p_user_id: string }; Returns: number }
      ...
      process_vision_validation: { Args: never; Returns: Json }
      ...
      run_ai_screenshot_analyzer: { Args: never; Returns: undefined }
      ...
      run_screenshot_cleanup: { Args: never; Returns: undefined }
      run_screenshot_processor: { Args: never; Returns: undefined }
      run_vision_validator: { Args: never; Returns: undefined }
      send_daily_hours_alert_per_org: { Args: never; Returns: undefined }
      send_email_report: {
